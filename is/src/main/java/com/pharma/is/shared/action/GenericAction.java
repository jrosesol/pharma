package com.pharma.is.shared.action;
...
public class GenericAction extends UnsecuredActionImpl<GenericAction.GenericResult> {
  ...
  private class ExecutionCallback implements AsyncCallback<GenericAction.GenericResult> {
